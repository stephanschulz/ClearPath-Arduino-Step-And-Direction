This Library sends pulsed step and Direction signals to ClearPath motors to precisely control position, and velocity of up to 6 motors simultaneously up to 4000RPM.  The methodology used to create the pulse step and direction signals is not compatible with stepper motors, or with other servo systems.  The pulsed step and direction also requires a RAS setting of at least 16 ms on all ClearPath motors, a longer RAS will results in quieter motion.
